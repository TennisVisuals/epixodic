...
*Rally bars are back! Yellow for length, green for winners, red for errors.*  
*Momentum lines now fluctuate based on distance-to-set calculation.*  
*All visualizations rendering with UMO v4 data structure.*
